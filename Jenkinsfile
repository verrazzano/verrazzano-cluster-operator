...
pipeline {
    ...
    environment {
        DOCKER_CI_IMAGE_NAME = 'verrazzano-cluster-operator-jenkins'
        DOCKER_PUBLISH_IMAGE_NAME = 'verrazzano-cluster-operator'
        ...
        stage('Clean workspace and checkout') {
            steps {
                ...
                sh """
                    ...
                    rm -rf ${GO_REPO_PATH}/verrazzano-cluster-operator
                    mkdir -p ${GO_REPO_PATH}/verrazzano-cluster-operator
                    tar cf - . | (cd ${GO_REPO_PATH}/verrazzano-cluster-operator/ ; tar xf -)
                """
            }
        }
